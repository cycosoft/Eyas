---
description: Component patterns, state management, and testing standards for the Vue 3 frontend interface in Eyas.
when_to_use: Use when building or refactoring Vue components in src/eyas-interface/, or when managing UI state via Pinia or styling with Vuetify.
allowed-tools: Read,Edit,Bash
paths:
  - "src/eyas-interface/**/*.vue"
  - "src/eyas-interface/**/*.ts"
---
