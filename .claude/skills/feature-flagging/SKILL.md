...
when_to_use: Use when asked to temporarily disable a feature or UI element, when investigating logic flow by bypassing specific sections of code, or when implementing "coming soon" features that should be merged but not active.
