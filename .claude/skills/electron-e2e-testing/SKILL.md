...
when_to_use: Use when writing or debugging Playwright E2E test suites (tests/e2e/), or when encountering resource lock errors or unclosed Electron runner instances during testing.
