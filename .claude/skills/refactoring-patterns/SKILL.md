...
when_to_use: Use when refactoring modules that exceed max-lines or max-lines-per-block, or when extracting business logic or state from large orchestrators or Vue components.
