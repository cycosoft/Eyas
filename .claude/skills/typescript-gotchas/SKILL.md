...
when_to_use: Use when encountering TypeScript narrowing errors (never) during unit test mocking, or when refactoring complex type structures or migrating internal APIs.
