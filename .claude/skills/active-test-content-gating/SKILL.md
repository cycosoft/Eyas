...
when_to_use: Use when debugging or extending AppHeader, AppHeaderOmniHub, or related navigation components, handling Electron IPC payloads in the Vue UI store, or troubleshooting Vitest UI component test state leaks.
